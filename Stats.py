...
class Stats(pygame.surface.Surface):
    ...
    def __init__(self, height, width):
        ...
        self.images = [
            pygame.image.load(os.path.join("images", "attack.png")),
    ...
    def update_stats(self, e):
        ...
        if e == None:
            ...
            pygame.surface.Surface.blit(
                self, self.arial_font.render("Stats: ", True, white), (0, 0)
            )
            ...
            pygame.surface.Surface.blit(
                self, self.arial_font.render(e.name, True, white), (0, 20)
            )
            pygame.surface.Surface.blit(
                self, self.arial_font.render(health, True, white), (0, 40)
            )
            pygame.surface.Surface.blit(self, self.images[0], (0, 60))
            pygame.surface.Surface.blit(
                self, self.arial_font.render(strength, True, white), (32, 60)
            )
            pygame.surface.Surface.blit(self, self.images[1], (64, 60))
            pygame.surface.Surface.blit(
                self, self.arial_font.render(defense, True, white), (96, 60)
            )
            pygame.surface.Surface.blit(
                self, self.arial_font.render(job, True, white), (0, 100)
            )
            pygame.surface.Surface.blit(
                self, self.arial_font.render(experience, True, white), (0, 120)
            )
            pygame.surface.Surface.blit(
                self, self.arial_font.render(level, True, white), (0, 140)
            )
